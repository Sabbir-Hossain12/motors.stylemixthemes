<header class="header-style-1">
        ...
        <div class="header-top-inner">
            <div class="cnt-account">
                <ul class="list-unstyled">
                    ...
                    <li><a target="_blank" href="{{ $basicinfo->instagram }}"><i class="fa-brands fa-instagram"></i></a>
                    </li>
    ...
    <div class="col-12" id="d-lg-none">
        <marquee behavior="" direction="" style="color: #fff;background: #000339;font-weight:bold;">
            {{ $basicinfo->marquee_text }}</marquee>
    </div>
            ...
            <div class="row" style="margin: 0">
                <div class="col-9 col-sm-9 col-md-9 col-lg-3 logo-holder ps-0">
                    ...
                    <div class="logo" style="display: flex;justify-content:space-between">
                        <button type="button" class="d-none d-lg-block" onclick="openNav()" id="menubutton">
                ...
                <div class="p-0 col-3 col-sm-3 col-md-3 col-lg-2 animate-dropdown top-cart-row" style="margin-top: 10px;" id="headcart">
                    <div class="">
                    ...
                    <div class="d-none d-xl-inline-block" id="d-sm-none">
                        ...
                        @if (Auth::id())
                            <a href="#" type="button" onclick="openProfileNav()"
                                style="color: #120d3f;font-size:20px"><i class="fa-solid fa-user" color="#120d3f"></i></a>
                        @else
                    ...
                    <a type="button" class="search-button d-lg-none" onclick="showser()"
                        ...
                        id="smsericon"><img src="{{ asset('public/search.png') }}" style="width:35px"></a>
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button type="submit" class="input-group-text bg-primary text-light"
                                    style="background: #120d3f !important;padding: 10.7px;margin-bottom: 2px;margin-left: -10px;margin-top: -1px;border-radius: 0px 4px 4px 0px;">
