                        ...
                        <div class="col-sm-12 col-md-6 product-info-block" id="paddingnone">
                            <div class="product-info" id="productinfo">
                                ...
                                <div class="text-center quantity-container info-container"
                                    ...
                                    <form name="form" action="{{ url('add-to-cart') }}" id="submitaddtocart"
                                        ...
                                        <button type="submit"
                                            ...
                                            style="background:#120d3f;color:white;width: 100%;font-size: 17px;">
                                            অর্ডার করুন
                                        </button>
                                    </form>
                                ...
                                <div class="text-center quantity-container info-container"
                                    style="width: 100%;border-bottom: 1px solid #dfd6d6; float: left;">
                                    <div class=""
                                        style="justify-content: left;width: 50%;float: left;text-align: center;">
                                        <a class="btn" id="formTextBtn"
                                            href="tel:{{ App\Models\Basicinfo::first()->phone_one }}"><i
                                                class="fas fa-phone"></i> <span class="animate-charcter">
                                                {{ App\Models\Basicinfo::first()->phone_one }}</span> </a>
                                    </div>
            ...
            <div class="col-12">
                ...
                <section class="pb-2 section featured-product wow fadeInUp" id="cateoryPro"
                    ...
                    <h3 class="section-title"
                        style="border-bottom: 1px solid #120d3f; padding: 8px;margin-bottom: 0;">Related
                        products</h3>
